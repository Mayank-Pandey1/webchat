...
const LoginPage = () => {
  ...
  const [isDataSubmitted, setIsDataSubmitted] = useState(false)   //to track when the input/signup details will be submitted, we will set bio after that
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center 
      ...
      <form
        ...
        {currState === "Sign up" && !isDataSubmitted && (   //isDataSubmitted should be false
          <input 
